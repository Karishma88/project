               ...
               while ($row=mysqli_fetch_array($query)) {
                 ...
                 <tr>
                  ...
                  <td><?php echo $row['admin'];?></td>
                   ...
                   <td><a class= "btn btn-danger btn-sm" href="news_delete.php?delete=<?php echo $row['id'];?>">delete</a></td>
                ...
                <ul class="pagination justify-content-center mb-4">
                    ...
                    <li class="<?php if($pageno <= 1){ echo 'disabled'; } ?> page-item">
                        ...
                        <a href="<?php if($pageno <= 1){ echo '#'; } else { echo "?pageno=1 ".($pageno - 1); } ?>" class="page-link">Prev</a>
...
<a href="<?php if($pageno >= $total_pages){ echo '#'; } else { echo "?pageno= 1 ".($pageno + 1); } ?> " class="page-link">Next</a>
