      ...
      <div class="row">
        <div class="col-md-8 blog-main">
          ...
          <div class="blog-post">
            ...
            <p><img  class ="img img-thumbnail"  style= " width: 50%; height: 30%;" src="image/<?php echo $row['thumbnail']; ?>" ></p>
            <hr>
            
            <blockquote>
             <?php echo substr ($row['description'],0,300); ?>
             <a href="single_page.php?single=<?php echo $row['id'];?>" class="btn btn-primary btn-primary-sm">Read More</a>
            </blockquote>
